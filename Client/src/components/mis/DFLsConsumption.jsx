...
export default function DFLsConsumption({ user }) {
  ...
  return (
    <div className="gov-data-entry">
      <div className="gov-page-title">
        <div className="gov-page-title-icon"><Database size={20} /></div>
        <div>
          <h2>DFLs Consumption</h2>
          <p>Disease-free layings consumption — Monthly MIS Report &nbsp;·&nbsp;
      ...
      {VARIETIES.map(variety => (
        <div key={variety} className={`gov-table-card gov-cat-card ${VARIETY_COLOR[variety]}`}>
          <div className="gov-cat-header">
            ...
            <h4>{variety} — DFLs Consumption</h4>
          </div>
          {loading ? (
